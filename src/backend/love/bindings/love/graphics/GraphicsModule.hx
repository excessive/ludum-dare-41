...
extern class GraphicsModule
{
	...
	@:overload(function (color:Table<Dynamic,Dynamic>, stencilvalue: Int, depthvalue: Float) : Void {})
	...
	public static function setDepthMode(method: CompareMode = Always, enablewrites: Bool = false): Void;
	public static function setMeshCullMode(mode: CullMode): Void;
	public static function setFrontFaceWinding(winding: FrontFaceWinding = Cw): Void;
	...
	public static function newCanvas(?width:Float, ?height:Float, ?format:Table<Int,CanvasFormat>, ?msaa:Float) : Canvas;
	...
	@:overload(function (canvases:Table<String, Dynamic>): Void {})
...
{
	var drawcalls : Int;
	var drawcallsbatched: Int;
	var canvasswitches : Int;
